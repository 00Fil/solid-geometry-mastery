        ...
        <section className="relative z-10 flex flex-col items-center justify-center min-h-screen w-full px-4 text-center select-none pointer-events-none">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="relative group">
                    <h1 className="font-display font-thin text-6xl md:text-8xl lg:text-9xl tracking-tight text-white mix-blend-overlay opacity-100 transition-opacity duration-700 drop-shadow-2xl">
                        LOTUS
                    </h1>
                </motion.div>
            ...
            {/* Footer */}
            <motion.footer
                className="absolute bottom-12 text-white/30 text-[9px] uppercase tracking-[0.5em] font-sans font-medium"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
